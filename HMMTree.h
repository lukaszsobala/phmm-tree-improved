...
"\n"
"Usage: phmm-tree <mode> <option> [-id <identity>] [-prc_hit <value>] [-acc] [input_option <path(s)>] [more options]\n"
"\n"
"USAGE (structured)\n"
"  phmm-tree <mode> [flags] <input_option> <path(s)> [more flags]\n"
"\n"
"MODES\n"
"  -prc      Compare profile HMMs in HMMER format using PRC. (optional when using -hmms or -als_phmms; implied)\n"
"  -hhsuite  Compare profile HMMs in HHM format using hhsuite. (optional when using -hhms or -als_phhms; implied)\n"
"\n"
"INPUT OPTIONS (choose one)\n"
"  -uals       Unaligned FASTA file with at least 9 sequences (provide a file path immediately after -uals).\n"
...
"\n"
"  -als        Directory containing at least three aligned FASTA files (provide a directory path immediately after -als).\n"
"               - prc_hit and -acc are supported (same as in -uals).\n"
"               - Provide only a directory path.\n"
"\n"
"  -als_phmms  Two folders: one with alignments and one with HMMER2.x/3.x profile HMM files (provide two paths immediately after -als_phmms: <hmms_path> <als_path>). Implies -prc.\n"
"               - Options are the same as for -hmms.\n"
"\n"
"  -als_phhms  Two folders: one with alignments and one with HHsuite HHM files (provide two paths immediately after -als_phhms: <hhms_path> <als_path>). Implies -hhsuite.\n"
"               - Options are the same as for -hhms.\n"
"\n"
"  -hmms       Directory with at least three HMMER2.x/3.x profile HMM files (provide a directory path immediately after -hmms). Implies -prc.\n"
"               - Options are the same as for -als.\n"
"\n"
"  -hhms       Directory with at least three HHsuite HHM files (provide a directory path immediately after -hhms). Implies -hhsuite.\n"
"               - Options are the same as for -als.\n"
"\n"
"FLAGS\n"
"  -id <identity>         Usearch identity (0.1..1.0) for -uals.\n"
"  -prc_hit <value>       PRC parameter (default: 10; 0 uses PRC default 100).\n"
"  -acc                   Use the HMM file ACC field in matrix/tree if available (if not specified: use NAME).\n"
...
"\n"
"ANALYSIS METHODS (optional; if none specified, run all)\n"
"  -fitch    Run Fitch-Margoliash (both f-m and minimum evolution; slowest but most accurate).\n"
"  -kitsch   Run Kitsch (contemporary tips; both f-m and minimum evolution; slow).\n"
"            -fm       Run only f-m variants (affects Fitch and Kitsch).\n"
"            -min      Run only minimum evolution variants (affects Fitch and Kitsch).\n"
"  -nj       Run Neighbor-Joining algorithm (fast).\n"
"  -upgma    Run UPGMA (Unweighted Pair Group Method with Arithmetic Mean; ultrafast but fairly inaccurate).\n"
"\n"
...
"  -phylo_threads <num>   Number of threads for phylogenetic algorithms (default and recommended: 1, do not change unless you know what you're doing).\n"

"\n"
"EXAMPLES\n"
"  PRC + unaligned FASTA:\n"
"    phmm-tree -prc -id 0.9 -uals ./some_path/a.fasta\n"
"    phmm-tree -prc -id 0.9 -prc_hit 15 -uals ./some_path/a.fasta\n"
"    phmm-tree -prc -id 0.9 -prc_hit 15 -acc -uals ./some_path/a.fasta\n"
"    phmm-tree -prc -id 0.9 -fitch -fm -uals ./some_path/a.fasta\n"
"    phmm-tree -prc -id 0.9 -kitsch -min -uals ./some_path/a.fasta\n"
"    phmm-tree -prc -id 0.9 -fitch -upgma -uals ./some_path/a.fasta\n"
"    phmm-tree -hhsuite -id 0.9 -nj -uals ./some_path/a.fasta\n"
"\n"
"  PRC + aligned FASTA folder:\n"
"    phmm-tree -prc -als ./some_path/\n"
"    phmm-tree -prc -prc_hit 15 -als ./some_path/\n"
"    phmm-tree -prc -prc_hit 15 -acc -als ./some_path/\n"
"    phmm-tree -prc -kitsch -nj -als ./some_path/\n"
"    phmm-tree -prc -fitch -fm -als ./some_path/\n"
"    phmm-tree -hhsuite -als ./some_path/\n"
"\n"
"  PRC + alignments with HMMER HMMs:\n"
"    phmm-tree -prc -als_phmms ./some_hmms_path/ ./some_als_path/\n"
"    phmm-tree -prc -prc_hit 15 -als_phmms ./some_hmms_path/ ./some_als_path/\n"
"    phmm-tree -prc -prc_hit 15 -acc -als_phmms ./some_hmms_path/ ./some_als_path/\n"
"    phmm-tree -prc -fitch -upgma -als_phmms ./some_hmms_path/ ./some_als_path/\n"
"    phmm-tree -prc -kitsch -min -als_phmms ./some_hmms_path/ ./some_als_path/\n"
"\n"
"  HHsuite + alignments with HHMs:\n"
"    phmm-tree -hhsuite -als_phhms ./some_hhms_path/ ./some_als_path/\n"
"    phmm-tree -hhsuite -nj -upgma -als_phhms ./some_hhms_path/ ./some_als_path/\n"
"\n"
"  PRC + HMMER HMM folder:\n"
"    phmm-tree -hmms ./some_path/   # '-prc' implied\n"
"    phmm-tree -prc -prc_hit 15 -hmms ./some_path/\n"
"    phmm-tree -prc -prc_hit 15 -acc -hmms ./some_path/\n"
"    phmm-tree -prc -fitch -hmms ./some_path/\n"
"    phmm-tree -prc -kitsch -fm -hmms ./some_path/\n"
"\n"
"  HHsuite + HHM folder:\n"
"    phmm-tree -hhms ./some_path/   # '-hhsuite' implied\n";
/* public_functions */
