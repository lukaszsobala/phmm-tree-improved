...
"\n"
"  -als_phmms  Two folders: one with alignments and one with HMMER2.x/3.x profile HMM files (provide two paths immediately after -als_phmms: <hmms_path> <als_path>).\n"
"               - Options are the same as for -hmms.\n"
"\n"
"  -als_phhms  Two folders: one with alignments and one with HHsuite HHM files (provide two paths immediately after -als_phhms: <hhms_path> <als_path>).\n"
"               - Options are the same as for -hhms.\n"
"\n"
"  -hmms       Directory with at least three HMMER2.x/3.x profile HMM files (provide a directory path immediately after -hmms).\n"
"               - Options are the same as for -als.\n"
"\n"
"  -hhms       Directory with at least three HHsuite HHM files (provide a directory path immediately after -hhms).\n"
"               - Options are the same as for -als.\n"
"\n"
"FLAGS\n"
